...
class SpoCdnPolicySetCommand extends SpoCommand {
  ...
  Examples:
    ...
    Set the list of extensions supported by the Public CDN
      ${chalk.grey(config.delimiter)} ${commands.CDN_POLICY_SET} --type Public --policy IncludeFileExtensions --value CSS,EOT,GIF,ICO,JPEG,JPG,JS,MAP,PNG,SVG,TTF,WOFF,JSON
