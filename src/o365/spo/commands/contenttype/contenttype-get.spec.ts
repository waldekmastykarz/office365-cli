...
describe(commands.CONTENTTYPE_GET, () => {
  ...
  it('gets information about a list content type', (done) => {
    sinon.stub(request, 'get').callsFake((opts) => {
      if (opts.url.indexOf(`/_api/web/lists/getByTitle('Events')/contenttypes('0x010200973548ACFFDA0948BE80AF607C4E28F9')`) > -1) {
  ...
  it('correctly escapes special characters in the content type id', (done) => {
    sinon.stub(request, 'get').callsFake((opts) => {
      if (opts.url.indexOf(`/_api/web/contenttypes('0%3D0100558D85B7216F6A489A499DB361E1AE2F')`) > -1) {
  ...
  it('correctly handles list content type not found', (done) => {
    sinon.stub(request, 'get').callsFake((opts) => {
      if (opts.url.indexOf(`/_api/web/lists/getByTitle('Documents')/contenttypes('0x0100558D85B7216F6A489A499DB361E1AE2F')`) > -1) {
        return Promise.resolve({
          "odata.null": true
        });
      }
